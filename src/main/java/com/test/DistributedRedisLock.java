...
public class DistributedRedisLock {
     ...
     */
    public DistributedRedisLock(RedisTemplate redisTemplate, String lockKey, int expireTime) {
     ...
     */
    public DistributedRedisLock(RedisTemplate redisTemplate, String lockKey, long timeOut) {
        this(redisTemplate, lockKey);
     ...
     * @param timeOut       请求锁的超时时间(单位：毫秒)
     */
    public DistributedRedisLock(RedisTemplate redisTemplate, String lockKey, int expireTime, long timeOut) {
    ...
    public boolean unlock() {
        ...
        // 只有加锁成功并且锁还有效才去释放锁
        if (locked) {
            System.out.println("Enter into unlocked");
            try {
...
//                    values.add(lockValue);
                    ...
                    if (nativeConnection instanceof Jedis) {
                        ...
                        System.out.println("单机模式unlock result"+result);
                    }
